...
class _HomePageState extends State<HomePage> {
  List<Call> calls = [];         /// Mandatory
  bool hasPermission = false;   /// Mandatory
  bool callShouldFail = false;  /// Mandatory
  String? phoneid;             /// Mandatory
  late final String uuid;      /// Mandatory
  ...
  void initState() {
    ...
    FlutterVoipKit.init(
        ...
        callActionHandler: callActionHandler);             /// Mandatory
