    ...
    return BlocProvider.value(
      ...
      child: BlocConsumer<ChatAppCubit,ChatAppCubitStates>(
        ...
        builder:(context,states) {
          ChatAppCubit.get(context).UserAvilableAtMessenger = true;
          ChatAppCubit.get(context).UnseenMsgesClear(receiverId: Contact.uId.toString());
          print(ChatAppCubit.get(context).UserAvilableAtMessenger);
          ...
          body:WillPopScope(
            onWillPop: () async{
               ChatAppCubit.get(context).UserAvilableAtMessenger = false;
               print(ChatAppCubit.get(context).UserAvilableAtMessenger);
              return true;
            },
            child: Column(
                              ...
                              child: Padding(
                                ...
                                child: IconButton(highlightColor:Colors.red ,onPressed: (){
                                  ChatAppCubit.get(context).sendMessage(
                                    ...
                                    SenderImage: ProfileCubit.get(context).CurrentUser[0].image.toString(),
                                    SenderName: ProfileCubit.get(context).CurrentUser[0].name.toString(),
                                    SenderPhone: ProfileCubit.get(context).CurrentUser[0].phone.toString(),
